...
class ParticleFilter(object):
    ...
    def __init__(self, frame, template, **kwargs):
        ...
        """
        self.num_particles = 50  # required by the autograder
        self.sigma_exp = 0.1  # required by the autograder
        #self.sigma_exp = 0.1*self.sigma_exp
        self.sigma_dyn = 0.1  # required by the autograder
        ...
        print("origin weights: ",self.weights)
    ...
    def process(self, frame):
        ...
        temp = cv2.cvtColor(img_temp,cv2.COLOR_GRAY2BGR)
...
## Helper code
#def run_particle_filter(filter_class, frame, template_rect,
#                        save_frames={}, **kwargs):
...
#    pf = ParticleFilter(frame,template, **kwargs)
#    frame_num = 0
